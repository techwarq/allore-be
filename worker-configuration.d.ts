/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e43e8893baa80a56e5e3b8e63384ab14)
// Runtime types generated with workerd@1.20260401.1 2026-03-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GlobalLimiter" | "ChatSession";
	}
	interface DevEnv {
		DATABASE_URL: string;
		ENV: string;
	...
	interface Env {
		...
		DODO_WEBHOOK_SECRET?: "DODO_WEBHOOK_SECRET_PLACEHOLDER";
		GLOBAL_LIMITER?: DurableObjectNamespace<import("./src/index").GlobalLimiter>;
		CHAT_SESSION?: DurableObjectNamespace<import("./src/index").ChatSession>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "ENV" | "JWT_SECRET" | "RESEND_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_API_KEY" | "GEMINI_API_KEY" | "GOOGLE_CLIENT_SECRET" | "FRONTEND_URL" | "API_URL" | "BROWSERBASE_API_KEY" | "BROWSERBASE_PROJECT_ID" | "STAGEHAND_ENV" | "PINTEREST_COOKIE" | "QDRANT_URL" | "QDRANT_API_KEY" | "DODO_PAYMENTS_API_KEY" | "DODO_WEBHOOK_SECRET">> {}
}
