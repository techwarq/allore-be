...
export type SimpleShootInput = {
  ...
  vibeImageUrl?: string  // real Pinterest reference the user picked (vibe-picker gate) — fed to the Creative Director as a mood reference, not a product/model image
}
